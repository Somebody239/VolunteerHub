...
const schema = z.object({
  ...
  interests: z.string().max(500, "Too many interests").optional(), // CSV
...
const OnboardingVolunteer: React.FC = () => {
  ...
  const form = useForm<FormValues>({ resolver: zodResolver(schema), defaultValues: { fullName: "", school: "", location: "", interests: "", availability: "" } });
