...
interface NavigationProps {
  activeTab: 'home' | 'jobs' | 'profile' | 'org' | 'org_jobs';
}
...
export const Navigation = ({ activeTab }: NavigationProps) => {
  ...
  const navItems = isOrganizer
    ? [
        ...
        { id: 'org_jobs', icon: Briefcase, label: 'Jobs', to: '/org/jobs' } as const,
        { id: 'profile', icon: User, label: 'Profile', to: '/org/profile' } as const,
      ]
    : [
