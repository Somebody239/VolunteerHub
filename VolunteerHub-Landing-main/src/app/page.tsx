        ...
        <div className={`${container} relative z-10 grid lg:grid-cols-2 gap-12 items-center pb-24 pt-10`}>
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Link href="#get-started" className="inline-flex items-center gap-2 rounded-full bg-white text-black px-5 py-3 text-sm font-medium hover:bg-zinc-200 transition">
                Get Started
                <ArrowRight className="h-4 w-4" />
              </Link>
              <Link href="#org" className="inline-flex items-center gap-2 rounded-full border border-white/10 px-5 py-3 text-sm text-zinc-200 hover:bg-white/5 transition">
                For Organizations
              </Link>
            </div>
      ...
      <section id="get-started" className="py-20">
        <div className={`${container} text-center`}>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            <Link href="#" className="inline-flex items-center gap-2 rounded-full bg-white text-black px-5 py-3 text-sm font-medium hover:bg-zinc-200 transition">Sign Up as a Student<ArrowRight className="h-4 w-4"/></Link>
            <Link href="#post" className="inline-flex items-center gap-2 rounded-full border border-white/10 px-5 py-3 text-sm text-zinc-200 hover:bg-white/5 transition">Post an Opportunity</Link>
          </div>
        </div>
      </section>
